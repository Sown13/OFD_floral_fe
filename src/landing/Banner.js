...
const bannerImages = [
    ...
    {
        id: 2,
        src: "/images/hoakhaitruong/hoakhaitruong3.jpg",
...
function Banner() {
    ...
    return (
        <div id="bannerCarousel" className="carousel slide" data-bs-ride="carousel" style={{ marginTop: "56px" }}>
            {/* Indicators */}
            ...
            <div className="carousel-inner">
                {bannerImages.map((banner, index) => (
                    <div key={banner.id} className={`carousel-item ${index === activeIndex ? "active" : ""}`} data-bs-interval="2000">
                        <div className="ratio" style={{ "--bs-aspect-ratio": "50%", height: "450px", overflow: "hidden" }}>
                            <img
                                alt={banner.title}
                                src={banner.src}
                                style={{
